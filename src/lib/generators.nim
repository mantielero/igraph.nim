...
proc newRing*(n:int; directed:bool; mutual:bool; circular:bool):Graph =
  # https://igraph.org/c/doc/igraph-Generators.html#igraph_ring
  result = new Graph
...
proc newFull*(n:int; directed:enumigraphidirectedt ; loops:enumigraphloopst):Graph =
  result = new Graph
