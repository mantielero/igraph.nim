...
# Basic Interface
# ===============
# https://igraph.org/c/html/0.9.4/igraph-Basic.html#basic-interface


# ---------------------------------------
# 2.1. Graph constructors and destructors
# ---------------------------------------
# https://igraph.org/c/html/0.9.4/igraph-Basic.html#graph-constructors-and-destructors
...
# TODO: 2.1.2. igraph_empty_attrs — Creates an empty graph with some vertices, no edges and some graph attributes.
# https://igraph.org/c/html/0.9.4/igraph-Basic.html#igraph_empty_attrs


# 2.2. Basic query operations
# https://igraph.org/c/html/0.9.4/igraph-Basic.html#basic-query-operations
